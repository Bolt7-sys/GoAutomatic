            ...
            <div className="bg-white rounded-3xl border-2 border-gold p-8 md:p-12 shadow-sm">
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    placeholder="Tell us what tasks you want to run automatically and How can we help your business, 1. Save business time 2. Reduce Business Cost 3. Increace business revue"
                    rows={5}
